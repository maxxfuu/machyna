...
function CursorLines() {
  ...
  return (
    <div ref={containerRef} className="relative mt-15 h-96 mx-auto px-16 max-w-7xl">
      <canvas 
        ref={canvasRef}
  ...
  return(
    <section className="bg-[#B51A38] text-white px-16 py-20">
      <div className="max-w-6xl mx-auto mb-16">
        ...
        <div className="container text-3xl md:text-4xl font-bold mt-4" ref={containerRef} style={{ visibility: "hidden" }}>
          <h2 className="flex flex-row">
            SmartCart provides a <span className="text-[#FF3643]">seamless, secure, and personalized</span> experience.
          </h2>
        </div> 
